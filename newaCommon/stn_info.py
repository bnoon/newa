...
'kee': {'name': 'Keene (Fisk Highlands)', 'vars': ['temp', 'lwet', 'prcp', 'rhum', 'wspd', 'wdir', 'srad'], 'lat': 44.239743, 'lon': -73.768373, 'elev': 1400, 'network': 'newa', 'state': 'NY'},
...
'ct_nwi': {'name': 'North Windham, CT', 'vars': ['temp', 'lwet', 'prcp', 'rhum', 'wspd', 'wdir', 'srad'], 'srqual': 'ok', 'lat': 41.721570, 'lon': -72.167526, 'elev': 301, 'network': 'newa', 'state': 'CT'},
