...
'pre_biofix': {
0: { 'ddlo':   0, 'ddhi':1168, 'altref': ["Dormant","Silver_Tip","Green_Tip","Half-Inch_Green","Tight_Cluster","Pink_Bud","Bloom","Petal_Fall","Post_Petal_Fall"],
							   'stage': "Overwintering as pupae", 
                               'status': "Predicted first emergence of <a href='http://nysipm.cornell.edu/factsheets/treefruit/pests/am/am.asp' target='_blank'>apple maggot</a> occurs after approximately 1169 to 2057 degree days have accumulated.", 
                               'management': "No control measures recommended at this time." },
1: { 'ddlo':1169, 'ddhi':2057, 'altref': ["Pre_1"],
...
2: { 'datelo':(8,1,0), 'datehi':(8,15,23), 'altref': ["Post_2"],
                               ...
                               'pesticide_link': "http://treefruitipm.info/PesticidesForPest.aspx?PestID=19&GrowthStageID=12" },
3: { 'datelo':(8,16,0), 'datehi':(10,1,23), 'altref': ["Post_3"],
