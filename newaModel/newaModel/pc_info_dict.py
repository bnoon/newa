...
'pre_biofix': {
0: { 'ddlo':   0, 'ddhi': 299, 'altref': ["Dormant","Silver_Tip","Green_Tip","Half-Inch_Green","Tight_Cluster"],
...
1: { 'ddlo': 300, 'ddhi': 349, 'altref': "Pink_Bud",
...
2: { 'ddlo': 350, 'ddhi': 449, 'altref': "Bloom",
                               ...
                               'management': "No control measures are recommended at this time because fruit has not yet begun to develop and reach a susceptible stage for injury from plum curculio adults." },
3: { 'ddlo': 450, 'ddhi':560, 'altref': ["Petal_Fall"],
