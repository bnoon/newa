...
mm_to_inch = units.new('millimeter','inch')
global systemInfo
systemInfo = os.uname()
...
class general_dm(object):
	...
	def process_weather(self,test=None):
		...
		all_weather = get_weather.get_mildew_weather(self.stn,self.eDate,sister)
		...
		retCode =  _dmC.process_weatherdata()
