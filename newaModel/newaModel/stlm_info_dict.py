...
'pre_biofix': {
0: { 'ddlo':   0, 'ddhi':  73, 'altref': ["Dormant"],
							   'stage': "Pupae overwintering", 
                               'status': "The first flight of <a href='http://nysipm.cornell.edu/factsheets/treefruit/pests/stlm/stlm.asp' target='_blank'>STLM</a> adults has not yet started.  First flight begins after 165 to 315 degree days have accumulated. Pheromone traps should be deployed for monitoring the adults.", 
...
1: { 'ddlo':  74, 'ddhi': 200, 'altref': ["Silver_Tip","Green_Tip","Half-Inch_Green"],
...
2: { 'ddlo': 201, 'ddhi': 290, 'altref': ["Tight_Cluster"],
							   'stage': "Moths flying and beginning to lay eggs",
                               'status': "First <a href='http://nysipm.cornell.edu/factsheets/treefruit/pests/stlm/stlm_fig2.asp' target='_blank'>eggs</a> are usually laid at early tight cluster on the first leaves to unfold.",
                               'management': "No control should be applied at this time and it is too early to sample for STLM eggs because oviposition has just begun." },
3: { 'ddlo': 291, 'ddhi': 366, 'altref': ["Pink_Bud"],
							   'stage': "Moths flying and egg laying continues",
                               'status': "First generation adult STLM are actively flying and laying eggs from tight cluster until the end of the pink bud stage.",
                               'management': "No insecticidal control sprays are recommended against STLM adults.  Control sprays targeted against younger instars of larvae (<a href='http://nysipm.cornell.edu/factsheets/treefruit/pests/stlm/stlm_fig4.asp' target='_blank'>sap feeding stages</a>) feeding in the leaves can be applied either at pink or shortly after petal fall.  To determine whether or not pink sprays are necessary, sample clusters for eggs at <a href='http://ipmguidelines.org/TreeFruits/content/CH07/default-4.asp' target='_blank'>pink</a> and if necessary apply insecticides before bloom. ",
                               'pesticide_link': "http://treefruitipm.info/PesticidesForPest.aspx?PestID=40&GrowthStageID=9" },
4: { 'ddlo': 367, 'ddhi': 479, 'altref': ["Bloom"],
...
5: { 'ddlo': 480, 'ddhi': 580, 'altref': ["Petal_Fall"],
                               ...
                               'pesticide_link': "http://treefruitipm.info/PesticidesForPest.aspx?PestID=40&GrowthStageID=11" }, 
6: { 'ddlo': 581, 'ddhi': 700, 'altref': ["Post_Petal_Fall"],
							   'stage': "1st generation tissue feeding mines and pupae in leaves",
                               'status': "Older tissue feeding mines and pupae are present. The secpmd generation of moths will emerge between 700 and 1200 degree days after first trap catch.", 
                               'management': "Pheromone traps should be checked frequently to determine the biofix of the second flight.  Usually, no treatments will be required to control the second generation of larvae if populations of first generation larvae are low or if effective control sprays have been applied against this generation."} } ,
'post_biofix': {  
0: { 'ddlo':   0, 'ddhi':1200, 'altref': ["Post_0"],
							   'stage': "2nd generation of moths emerging",
                               'status': "The second flight of STLM is beginning", 
                               'management': "No control sprays are necessary against adults.  Monitoring and control sprays should be targeted for the appearance of sap feeding mines from the second generation of larvae on the undersides of terminal leaves." } },
'post_biofix2': {  
0: { 'ddlo':   0, 'ddhi': 689, 'altref': ["Post_1"],
...
1: { 'ddlo': 690, 'ddhi': 839, 'altref': ["Post_2"],
                               ...
                               'management': "Sample terminal leaves for sap feeding STLM <a href='http://ipmguidelines.org/TreeFruits/content/CH07/default-10.asp' target='_blank'>mines<a>.  Apply a control spray if mine counts are above the recommended threshold.  It may be necessary to sample again later at 840 DD post-biofix if initial counts of mines are in region 2 of the chart.",
                               'pesticide_link': "http://treefruitipm.info/PesticidesForPest.aspx?PestID=40&GrowthStageID=12" },
2: { 'ddlo': 840, 'ddhi':1150, 'altref': ["Post_3"],
                               ...
                               'pesticide_link': "http://treefruitipm.info/PesticidesForPest.aspx?PestID=40&GrowthStageID=12" },
3: { 'ddlo':1151, 'ddhi':1600, 'altref': ["Post_4"],
							   'stage': "2nd generation mines and pupae in leaves; 3rd generation id moths emerging",
